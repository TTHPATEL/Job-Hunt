  ...
  try {
    ...
    return res
      ...
      .cookie("token", token, {
        ...
        sameSite: "None", // 🌐 Allows cross-site cookie usage (required if frontend and backend are on different domains)
        secure: true, // ✅ Ensures the cookie is only sent over HTTPS (required when using SameSite: "None")
      })
      .json({
